...
import { deleteBot, generateApiKey, uploadPdf } from "../controllers/botcontroller.js"; // Sahi function ka naam `uploadPdf` hai
...
router.route("/uploadpdf").post(isauthenticated, upload.single('pdfFile'), uploadPdf); // Corrected function name and added middleware
